...
pub struct EthBalanceBackendCanister {
    pub canister_id: Principal,
    pub caller: super::Caller,
}

impl EthBalanceBackendCanister {
    pub fn get_eth_balance(&self, arg0: String) -> super::CallBuilder<String> {
...
pub fn new(caller: &super::Caller, canister_id: Principal) -> EthBalanceBackendCanister {
    EthBalanceBackendCanister {
        canister_id,
        caller: caller.clone(),
    }
}

pub fn deploy(deployer: &super::Deployer) -> super::DeployBuilder<EthBalanceBackendCanister> {
    let args = Encode!();
